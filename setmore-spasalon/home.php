                                    ...
                                    <div class="panel-grid-cell">
                                        ...
                                        <div class="so-panel widget widget_text" id="panel-942-0-0-1">
                                            <div class="panel-textwidget">
                                                <h3  style="text-shadow: none;"><?php echo esc_html($setmore_spasalon_home_page_header) ?></h1>
                                                <h2 style="text-shadow: none;"><?php echo esc_html($setmore_spasalon_home_page_sub_hearder_color) ?><strong >&nbsp;<?php echo esc_html($setmore_spasalon_home_page_sub_hearder)?></strong></h2>
                                                <h4 style="line-height:30px;text-shadow: 0 0 0px #111;"> <?php echo esc_html($setmore_spasalon_home_page_description)?></h4>
                                            </div>
                                        </div>
        ...
        <div id="main" class="clearfix" role="main">
            ...
            <?php if ( have_posts() ) : ?>
                ...
                <?php while ( have_posts() ) : the_post(); ?>
                    <?php if (has_category("description cabinet")) : ?>
...
<div class= main-page-parallax-1>
    <div class="inner-title-wrap" style="padding : 50px 0 50px 0 ">>
        <div class="inner-title-box">
            <header class="entry-header">
                <h1 class="entry-title">Qu'est-ce que l'ostéopathie</h1>
            </header><!-- .entry-header -->
        </div>
    </div>
    ...
    <div id="content" class="clearfix">
        <div id="main" class="clearfix" role="main">
            <? // Ajoute les articles de type latest news ?>
            <?php wp_reset_postdata(); ?>
            <?php if ( have_posts() ) : ?>
                <div id="grid-wrap" class="main-page-post clearfix">
                <?php /* Start the Loop */ ?>
                <?php while ( have_posts() ) : the_post(); ?>
                    <?php if (has_category("latest news")) : ?>
                        <div <?php post_class('grid-box'); ?>>
                        <?php /* This piece of code is to retrieve the mini picture
                        If there is a picture inside the post, it will be able to catch it otherwize
                        it will try to find anotehr relative picture */ ?>
